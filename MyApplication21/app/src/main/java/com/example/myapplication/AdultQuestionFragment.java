...
public class AdultQuestionFragment extends Fragment {
    ...
    public static AdultQuestionFragment newInstance(int position, String question) {
        AdultQuestionFragment fragment = new AdultQuestionFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_adult_question, container, false);
